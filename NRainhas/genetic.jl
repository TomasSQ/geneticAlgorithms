...
function generateNewPopulation(oldPopulation, ranking)
  population = zeros(Int8, size(oldPopulation, 1), size(oldPopulation, 2))
...
function solve(populationSize, emptyPopulation, newIndividual)
  ...
  while generation != 1000000000
    ...
    population = generateNewPopulation(population, ranking)
  end
